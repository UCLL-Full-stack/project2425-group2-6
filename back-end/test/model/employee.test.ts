...
const employee = new Employee(id, firstName, lastName, email, password, experience, domain, licenseType);
...
test('given: invalid firstName, when: setFirstName, then: throw error', () => {
    const employee = () => 
        new Employee(id, "", lastName, email, password, experience, domain, licenseType)
...
test('given: invalid lastName, when: setLastName, then: throw error', () => {
    const employee = () => 
        new Employee(id, firstName, "", email, password, experience, domain, licenseType)
...
test('given: invalid email, when: setEmail, then: throw error', () => {
    const employee = () =>
        new Employee(id, firstName, lastName, "invalid-email", password, experience, domain, licenseType)
  expect(employee).toThrow("Invalid email format.");
});

test('given: invalid password, when: setPassword, then: throw error', () => {
    const employee = () =>
        new Employee(id, firstName, lastName, email, "short", experience, domain, licenseType)
...
test('given: invalid experience, when: setExperience, then: throw error', () => {
    const employee = () =>
        new Employee(id, firstName, lastName, email, password, -1, domain, licenseType)
...
test('given: invalid domain, when: setDomain, then: throw error', () => {
    const employee = () =>
        new Employee(id, firstName, lastName, email, password, experience, "", licenseType)
  expect(employee).toThrow("Domain must not be empty.");
});

test('given: invalid licenseType, when: setLicenseType, then: throw error', () => {
    const employee = () =>
        new Employee(id, firstName, lastName, email, password, experience, domain, "")
