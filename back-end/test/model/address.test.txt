...
const address = new Address(1, houseNumber,street,  city,  state, zip);
...
test('given: invalid state, when: setState, then: throw error', () => {
    const address = () =>
        new Address(1, houseNumber, street, city, "", zip)
...
test('given: invalid zip, when: setZip, then: throw error', () => {
    const address =  () =>
        new Address(1, houseNumber, street, city, state, "")
