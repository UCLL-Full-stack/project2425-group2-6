...
customerRouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        res.status(200).json(yield customer_service_1.default.getAllCustomers());
    }
    catch (error) {
...
customerRouter.post("/signup", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        res.status(200).json(yield customer_service_1.default.createCustomer(req.body));
    }
    catch (error) {
        if (error instanceof Error) {
            res.status(400).json({ error: "error", errorMessage: error.message });
...
customerRouter.post("/login", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(200).json(yield customer_service_1.default.authenticate(email, password));
    }
    catch (error) {
        if (error instanceof Error) {
